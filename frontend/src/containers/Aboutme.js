...
import mte from '../images/mte.png';
import wm from '../images/images-OBJECTS.svg'
function Aboutme() {
...
return(
    ...
    <div class="main">
     ...
     <img className='imgr2' src={wm} alt='logo'/>
      ...
      <li class="card-social__item">
        <a href='https://twitter.com/_ismayank'>
      <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" >
    ...
    <li class="card-social__item">
      <a href="https://www.linkedin.com/in/mayank-singh-34298922b">
      <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
